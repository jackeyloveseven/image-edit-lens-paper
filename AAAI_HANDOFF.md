...
> 真错（见 §4 坑 1）。最后更新 2026-07-17（新增：07-16 合并改稿超页事故与 07-17 砍页修复，见 §4 坑 4）。
...
| 交付物 | 文件 | 状态 |
|---|---|---|
| 主论文 PDF | `main_aaai.pdf` | **8 页**（正文于第 7 页内结束，refs 第 7–8 页），0 错、0 undefined ref/cite、匿名干净 ✓（07-16 曾被合并改稿顶到 9 页，07-17 砍页修复，见 §4 坑 4） |
