...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.96\columnwidth]{figs/fig5_mechanism/fig5_mechanism.pdf}
  \caption{\textbf{Basis mismatch at L6.} Left: four decode conventions for
  \emph{car\_red} at $t{=}4$ (A: $\hat{x}_0{=}x_t{-}\sigma_t v_\ell$; B--D:
  sign-flip / direct-$v$ variants)---standard vs.\ image-like reads swap
  between L24 and L59. Right: 3-way probe accuracy (chance $0.33$); L6/$t$4
  ($0.883$) exceeds the frozen-head score at the same cell.}
  \label{fig:mechanism}
\end{figure}

\begin{figure*}[t]
  \centering
  \includegraphics[width=0.92\textwidth]{figs/fig12_tuned_lens/fig12_tuned_lens.png}
  \caption{\textbf{Internal image vs.\ frozen-head ghost.} Top: tuned lens
  (fit on non-color edits, zero-shot on \emph{car\_red}) decodes a coherent
  scene at every depth at $t{=}0$. Bottom: at $t{=}12$, the frozen head on
  the same L36 state is a color-inverted ghost; the tuned lens is coherent.}
  \label{fig:tunedlens}
\end{figure*}
...
\begin{figure*}[t]
  ...
  the band (both steps). \textbf{B}: $\cos(v_\ell,v_{59})$ rises sharply.
