...
organizes the paper: \emph{the lens shows the translation, not the
decision -- reading the decision requires changing basis, and verifying it
requires intervention.} A generative editor natively thinks with an
internal image before it makes one; the lens turns that thought into
something that can be watched, steered, and budgeted for.
