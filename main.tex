...
\title{\LARGE\bf When Is the Edit Decided?\\[2pt]
\Large A Layer--Time Lens on How a Diffusion Editor Thinks with an Internal Image}

\author{%
Anonymous\thanks{Exploratory research preprint. Code: \texttt{image-edit-lens}.}\\
}
\date{}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig12_tuned_lens.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figs/fig13_transfer_onset.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig14_diff_lens.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figs/fig15_preview_lever.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig16_crossmodel_lens.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig17_k7_ladder.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig18_k8_decompose.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.98\textwidth]{figs/fig19_k9_curve.png}
...
\begin{figure}[!tp]
  \centering
  \includegraphics[width=0.88\columnwidth]{figs/h1b_steer_spectrum.png}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.47\columnwidth}
    \centering
    \includegraphics[width=\linewidth]{figs/i1d_recompose_grid.png}
    \caption{}
    \label{fig:recompose}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.47\columnwidth}
    \centering
    \includegraphics[width=\linewidth]{figs/i2_taxonomy_grid.png}
    \caption{}
    \label{fig:taxonomy}
  \end{subfigure}
...
(\texttt{torch.cuda.max\_memory\_allocated()}), consistent with the
project README's reported $\sim$58GB single-run baseline plus modest
