...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figs/fig2_method.pdf}
...
\input{aaai_draft/20_results_decided_early}
...
\input{aaai_draft/30_results_translated_late}
...
\input{aaai_draft/40_results_dissociation}
...
\input{aaai_draft/45_differential_preview}
...
\input{aaai_draft/50_results_generalize_lever}

\input{aaai_draft/60_limits_conclusion}
